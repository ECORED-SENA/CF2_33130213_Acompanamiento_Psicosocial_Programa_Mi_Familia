        ...
        subMenu: [
          {
            ...
            numero: '1.1',
            titulo:
              '¿Qué aspectos son relevantes en la comprensión de las familias por parte del PAF, desde los enfoques que considera el programa Mi familia?',
            hash: 't_1_1',
          },
          {
            icono: 'far fa-file-alt',
      ...
      },
      {
        ...
        subMenu: [
          ...
          },
          {
            icono: 'far fa-file-alt',
            numero: '2.2',
            titulo: 'Ficha de caracterización sociofamiliar (FCS)',
            hash: 't_2_2',
          },
          {
            icono: 'far fa-file-alt',
          ...
          },
          {
            icono: 'far fa-file-alt',
            numero: '2.5',
            titulo: 'Instrumentos de medición de habilidades',
            hash: 't_2_5',
          },
        ],
      },
      {
        ...
        subMenu: [
          ...
          },
          {
            ...
            numero: '3.3',
            titulo:
              '¿Existen escenarios para flexibilizar la propuesta metodológica que contempla las cartillas?',
            hash: 't_3_3',
          },
        ],
      },
